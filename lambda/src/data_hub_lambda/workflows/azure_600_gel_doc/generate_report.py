...
from data_hub_lambda.workflows.azure_600_gel_doc.image_processing import TIFFProcessor
...
def generate_report(run_id: str) -> str:
    ...
    page_properties: dict[str, Any] = {
        **create_report_page_properties_object(
        ...
        "Wavelengths": {"multi_select": [{"name": t} for t in tags["wavelength"]]},
        "Wavelength Colors": {"multi_select": [{"name": t} for t in tags["wavelength_color"]]},
    }
