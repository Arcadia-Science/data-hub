...
/**
 * Wraps a table actions cell so clicks inside it (edit dialog trigger,
 * approve/reject buttons, dropdown menus, etc.) don't bubble up to the
 * parent `<ClickableRow>` and trigger row navigation.
 *
