...
export function AuntyRunDetail({
  run,
  files,
    ...
    <>
      ...
      <RunDetail.FilesMetadataLayout>
        <RunDetail.Metadata
          ...
          run={run}
        >
          {hasAuntyMetadata(run.metadata as Record<string, unknown>) && (
            <AuntyRunBadges
      ...
      <AuntyPlateReport
        curvesFileId={auntyPlate?.curvesFileId ?? null}
        plate={auntyPlate?.plate ?? { experiments: [] }}
      />
    </>
  );
}
