        ...
        messages: [
          {
            ...
            content: {
              ...
              text: [
                ...
                `2. Call get_run_report_data with the same parameters to get structured experimental results (plate maps, well data, kinetic data, etc.).`,
                `3. Call list_run_files to see all associated files and their processing status.`,
                `4. Interpret the results:`,
                `   - Describe what type of experiment this was (based on metadata and data types)`,
                `   - Summarize key findings from the report data`,
        ...
        messages: [
          {
            ...
            content: {
              ...
              text: [
                ...
                `3. Call search_runs with instrumentId="${instrumentId}", sort="created_at", order="desc", perPage=5 to check recent run activity.`,
                `4. Diagnose:`,
                `   - Is the instrument active or inactive?`,
                `   - Are any watchers online? If not, how long since the last heartbeat?`,
        ...
        messages: [
          {
            ...
            content: {
              ...
              text: [
                ...
                `2. Call get_run_report_data for both runs to get their structured results.`,
                `3. Compare:`,
                `   - Experimental conditions (metadata differences)`,
                `   - Report data types present in each run`,
